...
import {beginPasswordReset , completePasswordReset , selectForgotPassword} from "../../redux/features/forgotPasswordSlice";
import LinearProgress from "@material-ui/core/LinearProgress";
import Divider from "@material-ui/core/Divider";
import {useHistory} from "react-router";
import CheckIcon from '@material-ui/icons/Check'
import {HistoryLink} from "../../Components/HistoryLink";
import { clearState } from "../../redux/features/forgotPasswordSlice";

const forgotInitValues = {
    username: ''
};
...
const ForgotPassword = () => {
    ...
    const onSubmitForgotPassword = (values,{ setSubmitting }) => {
        dispatch( beginPasswordReset({ username: values.username }) );
        setSubmitting(false);
    };

    const onSubmitResetPassword = (values, { setSubmitting }) => {
